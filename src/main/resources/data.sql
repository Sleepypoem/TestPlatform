...
`id`, `name`, `teacher_id`, `subject_id` , `content`, `created_at`, `updated_at`)
 VALUES (
 1, 'Math test',1, 1, '{"questions":[{"description": "what is the result of 6 + 6","type": "MULTIPLE","options":["4","8","12","22"],"answer": "3"},{"description": "what is the result of 3 x 3","type": "MULTIPLE","options":["15","8","12","9"],"answer": "4"}]}', '2023-11-05 14:55:41', NOW()
 );
 INSERT INTO `test-platform`.`tests` (
`id`, `name`, `teacher_id`, `subject_id` , `content`, `created_at`, `updated_at`)
 VALUES (
